...
function intersect_safe(a, b){
	...
	console.log("Ping from intersect safe!")
	console.log("a is: ", a)
	console.log("b is: ", b)
...
function LICA(){
    ...
    this.init = function() {
		...
		console.log("The stopwords set in the classifier are: ", this.webstoplist)
		...
		console.log("At the bottom, the current web stop list in the classifier is: ", this.webstoplist)
		
    }
	
	this.classify = function(url=false, title=false){
		
		console.log("At the top, the current web stop list in the classifier is: ", this.webstoplist)
		console.log("Also the length of the path rules is: ", Object.keys(this.path_rules).length)
		...
		console.log('LICA Classifier got url: ', url)
		console.log('LICA Classifier got title: ', title)
		...
		console.log("The current web stop list in the classifier is: ", this.webstoplist)
